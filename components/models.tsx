...
export const models = [
  ...
  },
  {
    ...
    icon: "./../Mistral.png",
    iconClass: "text-current",
    description: "mistral's most efficient reasoning model",
    color: "indigo",
    vision: false,
    reasoning: false,
    experimental: false,
  ...
  },
  {
    ...
    icon: "./../faviconV2.png",
    iconClass: "text-current",
    description: "meta's advanced vision model",
    color: "indigo",
    vision: false,
    reasoning: false,
    experimental: false,
  ...
  {
    value: "mmd-meta-llama/llama-3.2-11b-vision-instruct:free",
  ...
  {
    value: "mmd-opengvlab/internvl3-2b:free",
    label: "opengvlab/internvl3-2b:free",
    icon: "./../opengvlab.png",
    iconClass: "text-current",
    description: "opengvlab's most intelligent model",
    color: "indigo",
    vision: true,
    reasoning: false,
    experimental: false,
  ...
  {
    value: "mmd-DeepSeek-V3-0324",
    label: "DeepSeek-V3-0324",
    icon: "./../DeepSeek.png",
    iconClass: "text-current",
    description: "DeepSeek most intelligent model",
    color: "indigo",
    vision: false,
    reasoning: false,
    experimental: false,
  ...
  {
    value: "mmd-Meta-Llama-3.3-70B-Instruct",
    label: "Meta-Llama-3.3-70B-Instruct",
    icon: "./../faviconV2.png",
    iconClass: "text-current",
    description: "Meta-Llama most intelligent model",
    color: "indigo",
    vision: false,
    reasoning: false,
    experimental: false,
  ...
  {
    value: "mmd-Llama-4-Maverick-17B-128E-Instruct",
    label: "Llama-4-Maverick-17B-128E-Instruct",
    icon: "./../faviconV2.png",
    iconClass: "text-current",
    description: "Llama-4-Maverick most intelligent model",
    color: "indigo",
    vision: true,
    reasoning: false,
    experimental: false,
  ...
  {
    value: "mmd-Meta-Llama-3.1-8B-Instruct",
  ...
  {
    value: "mmd-E5-Mistral-7B-Instruct",
    label: "E5-Mistral-7B-Instruct",
    icon: "./../Mistral.png",
    iconClass: "text-current",
    description: "mistral embeddings",
    color: "indigo",
    vision: false,
    reasoning: false,
    experimental: false,
