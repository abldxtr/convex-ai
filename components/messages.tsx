...
import { CopyButton } from "@/components/markdown-advance";
import {
  MarkdownRenderer,
  preprocessLaTeX,
...
const Messages: React.FC<MessagesProps> = ({
            ...
            <div className="mt-5 mb-2 flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Image
                  ...
                  quality={100}
                />
                <h2 className="font-syne text-lg font-semibold text-neutral-800 dark:text-neutral-200">
                  Scira AI
                </h2>
              </div>
              {status === "ready" && (
  ...
  return (
    <div className="mb-32 space-y-4 sm:space-y-6">
        ...
        <div
          ...
          className={`${
            ...
            message.role === "assistant" && index < memoizedMessages.length - 1
              ? "mb-8! border-b border-neutral-200 pb-8 dark:border-neutral-800"
              : "mb-0"
          }`}
        >
          <Message
