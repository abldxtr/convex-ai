...
export const PlusIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    ...
    aria-label=""
    className="icon-md fill-[#5d5d5d] text-[#5d5d5d]"
  >
    <path
...
export const EarthIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
    fill="#5d5d5d"
    xmlns="http://www.w3.org/2000/svg"
    className="size-[18px] fill-[#5d5d5d] text-[#5d5d5d]"
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
...
export const LampIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    fill="#5d5d5d"
    viewBox="0 0 24 24"
    xmlns="http://www.w3.org/2000/svg"
...
export const PaintIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    width="22"
    height="22"
    viewBox="0 0 22 22"
...
export const ThreeDotsIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    ...
    fill="#5d5d5d"
    xmlns="http://www.w3.org/2000/svg"
    className="pointer-events-none h-5 w-5 text-[#5d5d5d]"
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
